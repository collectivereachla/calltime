...
export function CostumeBible({ productionId, scenes, cast, costumeEntries, paradeEntries, measurementEntries, canManage }: Props) {
  const [tab, setTab] = useState<"plot" | "parade" | "measurements">("plot");
